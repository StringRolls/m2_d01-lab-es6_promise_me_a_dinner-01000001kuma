...
.then(()=> obtainInstruction('steak', 7))
  ...
  .then(()=> obtainInstruction('steak', 8))
  .then( (step8) => {
...
async function makeBroccoli() {
  try {
    ...
    document.querySelector("#broccoli").innerHTML += `<li>"Broccoli maybe ready"</li>`
    document.querySelector("#broccoli").innerHTML += `<li>"Broccoli not ready"</li>`
